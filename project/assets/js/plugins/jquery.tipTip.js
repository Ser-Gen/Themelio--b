...
(function ($) {
	$.fn.tipTip = function (options) {
		var defaults = {
			...
			theme: 'black', // устанавливается тема, выбор из `black` и `white`
		...
		return this.each(function () {
			...
			if (org_elem.attr('data-delay')) { opts.defaultPosition = org_elem.attr('data-delay'); }
			if (org_elem.attr('data-fadeIn')) { opts.defaultPosition = org_elem.attr('data-fadeIn'); }
			if (org_elem.attr('data-fadeOut')) { opts.defaultPosition = org_elem.attr('data-fadeOut'); }
			...
			if (org_elem.attr('data-theme')) { opts.cssClass = org_elem.attr('data-theme'); }
			...
			function active_tiptip() {
				...
				if (opts.theme) {
					tiptip_holder.addClass('tip--'+ opts.theme);
				}
